...
<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center md:mt-[100px] mb-8 p-[18px] md:p-[2px]">
  ...
  <li className="bg-gray-300 font-[gotham] text-[0.95rem] opacity-80 text-gray-700 border border-gray-500 rounded-lg p-1">
    ...
    <div className="flex space-x-4 mt-6">
      <a  href="https://chat-app-mu-ebon.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-white live-site text-nowrap bg-[#457AD4] border border-black rounded-[0.3rem] p-[0.4rem] px-[1em] text-white shadow-[3px_3px_#000] text-[1.1rem] inline-flex items-center ">Live Site <HiMiniArrowTopRightOnSquare /></a>
      <a  href="https://github.com/ejimnkonye1/Chat-app" target="_blank" rel="noopener noreferrer" className="text-white live-site text-nowrap bg-[#353535] border border-black rounded-[0.3rem] p-[0.1rem] px-[1em] text-white shadow-[3px_3px_#000] text-[1.0rem] inline-flex items-center mr-[1rem]">Source Code <FaGithub /></a>
    </div>
  </div>
  <div className="flex justify-center order-1 md:order-2">
  <div className="lg:h-[350px] lg:w-[900px] bg-gray-800 p-4 rounded-[0.4rem] shadow-[5px_5px_0_#000,_-2px_-2px_0_#000] relative overflow-visible">
